 ...
 * Frames the developer as a person, not a resource.
 */
export function DeveloperProfileHeader({ developer }: DeveloperProfileHeaderProps): React.ReactElement {
  return (
    <div className="mb-7 flex items-start gap-4 pb-6 border-b border-stone-100 dark:border-stone-800">
      <Avatar name={developer.name} imageUrl={developer.avatarUrl} size="lg" />
      <div className="flex-1 min-w-0 pt-0.5">
        <h1 className="text-lg font-semibold tracking-tight text-stone-900 dark:text-stone-100">{developer.name}</h1>
